"""
Script to run the Database Copilot API.
"""
import os
import sys
import logging
...
def main():
    ...
    # Run the FastAPI app
    logger.info("Starting Database Copilot API")
    os.system(f"{sys.executable} -m uvicorn backend.api:app --host 0.0.0.0 --port 8000")
